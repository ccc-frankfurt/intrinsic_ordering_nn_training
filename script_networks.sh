...
do
 ...
 # CUDA_VISIBLE_DEVICES=0, python3 main.py --dataset VOCDetection --patch-size 224 --batch-size 128 --architecture $arc -lr 1e-1 --epochs 150 --num-networks 5 --scheduler StepLR --step-gamma 0.2 --step-size 50 --train-networks --multilabel --weight-decay 5e-4 --visualize-results --agreement-type exact_match
 # parameters for CIFAR10 dataset
 ...
 # parameters for KTH-TIPS dataset
