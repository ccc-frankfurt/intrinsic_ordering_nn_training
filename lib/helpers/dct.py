# This code is from https://github.com/zh217/torch-dct/blob/98c196dc0b62705068c13785e8681fb9bd076173/torch_dct/_dct.py#L32
# Instead of pytorch-dct, the code is imported,
# because the new pytorch version suggest using torch.fft module instead of directly torch.rfft
# (so that modification can be made when needed)
